...
class BasePredictor(object):
    def __init__(self, model, device,
        ...
        self.last_processed_image_nd = None
    ...
    def get_prediction(self, clicker, prev_mask=None):
        ...
        self.last_processed_image_nd = image_nd.clone()

        # pred_logits = self._get_prediction(image_nd, clicks_lists, is_image_changed)
        model_output = self._get_prediction(image_nd, clicks_lists, is_image_changed)
        pred_logits = model_output['instances']
        if 'attns' in model_output:
            self.last_att_maps = model_output['attns']
