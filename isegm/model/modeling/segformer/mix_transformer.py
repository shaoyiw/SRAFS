...
class MixVisionTransformer(nn.Module):
    ...
    def forward_features(self, x, additional_feature, points):
        ...
        attn_w_dict = self.attn_weight1(x, idxs_list[0]) if self.attn_weight[0] else None
        weights = attn_w_dict['attn_w_pos'] if self.attn_weight[0] and attn_w_dict else None
        ...
        if self.attn_weight[0] and attn_w_dict:
            attnW_pos.append(attn_w_dict['attn_w_pos'].reshape(B, 1, H, W))
            attnW_neg.append(attn_w_dict['attn_w_neg'].reshape(B, 1, H, W))
            if pos_click_len is None:
                pos_click_len = attn_w_dict['pos_click_len']
        ...
        attn_w_dict = self.attn_weight2(x, idxs_list[1]) if self.attn_weight[1] else None
        weights = attn_w_dict['attn_w_pos'] if self.attn_weight[1] and attn_w_dict else None
        ...
        if self.attn_weight[1] and attn_w_dict:
            attnW_pos.append(attn_w_dict['attn_w_pos'].reshape(B, 1, H, W))
            attnW_neg.append(attn_w_dict['attn_w_neg'].reshape(B, 1, H, W))
            if pos_click_len is None:
                pos_click_len = attn_w_dict['pos_click_len']
        ...
        attn_w_dict = self.attn_weight3(x, idxs_list[2]) if self.attn_weight[2] else None
        weights = attn_w_dict['attn_w_pos'] if self.attn_weight[2] and attn_w_dict else None
        ...
        if self.attn_weight[2] and attn_w_dict:
            attnW_pos.append(attn_w_dict['attn_w_pos'].reshape(B, 1, H, W))
            attnW_neg.append(attn_w_dict['attn_w_neg'].reshape(B, 1, H, W))
            if pos_click_len is None:
                pos_click_len = attn_w_dict['pos_click_len']
        ...
        attn_w_dict = self.attn_weight4(x, idxs_list[3]) if self.attn_weight[3] else None
        weights = attn_w_dict['attn_w_pos'] if self.attn_weight[3] and attn_w_dict else None
        ...
        if self.attn_weight[3] and attn_w_dict:
            attnW_pos.append(attn_w_dict['attn_w_pos'].reshape(B, 1, H, W))
            attnW_neg.append(attn_w_dict['attn_w_neg'].reshape(B, 1, H, W))
            if pos_click_len is None:
                pos_click_len = attn_w_dict['pos_click_len']
        ...
        return {'outs': outs, 'attns': attns, 'attnWs_pos': attnW_pos, 'attnWs_neg': attnW_neg, "idxs_list": idxs_list,
                "pos_click_len": pos_click_len}
