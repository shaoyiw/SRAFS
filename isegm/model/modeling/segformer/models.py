...
class BlockCA(nn.Module):
    ...
    #     x = x + self.drop_path(self.attn1(self.norm1(x), self.norm1(x), H, W))
    #     x = x_side + self.drop_path(self.attn2(self.norm_side(x_side), self.norm2(x), H, W))
